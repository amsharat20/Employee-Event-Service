...
public class TestEmployeeControllerGet {
	...
	public void testGetEmployee() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/api/v1/employees/{uuid}",uuid).accept(MediaType.APPLICATION_JSON);
	...
	public void testGetAllEmployees() throws Exception {
        ...
        RequestBuilder request = MockMvcRequestBuilders.get("/api/v1/employees").accept(MediaType.APPLICATION_JSON);
        mockMvc.perform(request).andExpect(status().isOk());
	}
}
